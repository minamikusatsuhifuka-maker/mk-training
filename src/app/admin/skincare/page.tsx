        ...
        <TableBody>
          {data.map((item) => (
            <TableRow key={item.id}>
              <TableCell className="px-2"><input type="checkbox" checked={selectedIds.has(item.id)} onChange={() => toggleSelect(item.id)} onClick={(e) => e.stopPropagation()} className="rounded" /></TableCell>
