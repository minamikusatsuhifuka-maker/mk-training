...
const ageRestrictionDrugs: AgeRestrictionDrug[] = [
  ...
  },
  {
    ...
    ageRule: [
      {
        type: "prohibited_under",
        description: "16歳未満：禁忌",
        detail: "添付文書：0.5%成人用は16歳以上に適応。16歳未満には0.25%小児用を使用すること。",
        warningLevel: "danger",
      },
    ],
    clinicalNote: "⚠️ 16歳未満への0.5%処方は禁忌。必ず0.25%小児用に変更。塗布量制限あり（1回5g・1日10gまで）。",
    source: "PMDA添付文書（コレクチム軟膏0.5%）Section 9.7",
  },
  {
    id: "moizelto-03",
    name: "モイゼルト軟膏0.3%",
  ...
  },
  {
    ...
    ageRule: [
      {
        type: "prohibited_under",
        description: "18歳未満：適応外",
        detail: "現時点で成人（18歳以上）のみに適応。小児への適応は未承認。",
        warningLevel: "warning",
      },
    ],
    clinicalNote: "2024年5月発売の新薬。現時点では成人専用。18歳未満への処方は適応外となりレセプト審査で返戻の可能性。",
    source: "PMDA添付文書（イブグリース皮下注）2024年",
  },
];
